# How to load Wormhole in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      baseline: 'Wormhole';
      repository: 'github://ezeBalsamo/Wormhole:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `ezeBalsamo` as owner name and `Wormhole`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Wormhole ...*
